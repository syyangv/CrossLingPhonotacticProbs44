...
* @rubach_lexical_1993 states that the palatal consonants of ⟨ť⟩, ⟨ď⟩, ⟨ľ⟩, and ⟨ň⟩ are in fact prepalatal (pg. 30); however, given that   @hanulikova_slovak_2010 and @short_slovak_1993 didn't make this distinction, I went with the standard palatal IPA symbols (pg. 374; pg. 535).  
...
* /v/ approximates to [ʋ] in syllable onsets preceding a vowel or liquid [@hanulikova_slovak_2010, pg. 374]. It also approximates to [ʋ] or [w] in coda positions.
...
* /n/ assimilates to [ɲ] prior to velar sounds and to [m] prior to labials [@hanulikova_slovak_2010]
* Obstruents assimilate in voicing (the preceding obstruent must assimilate to the following obstruent) [@rubach_lexical_1993, pg. 30]. /ch/ becomes [ɣ] in this case if voicing is required.
