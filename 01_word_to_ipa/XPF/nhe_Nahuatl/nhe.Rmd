...
* Kimball uses /λ/, which indicates /d͡ɮ/, in place of /t͡ɬ/ (Kimball, p. 196); however, this seems to be a minority view. (For instance, Beller outright states that /t͡ɬ/ is voiceless [@NheBeller1979, page 204].)
* Beller includes /ɡ/ as a phoneme that occurs, although rarely, in native words [@NheBeller1979, page 204]; however, the Crubadan corpus does not feature <g> except in loaned proper nouns, so based on current evidence I have opted to omit it.
...
Vowel length is not often retained, except in minimal pairs [@NheBeller1979, page 205]. Because of this, vowel length will be omitted in my rule set, except when it is explicitly illustrated by the doubling of vowel characters.

## Stress

Typically on the penultimate syllable. [@NheBeller1979, page 205]
...
* /ʔ/ is phonemic, but only in rare contexts [@NheBeller1979, page 204]; [@NheKimball1990, page 197]
...
* [ʔ] appended after word-final vowels [@NheKimball1990, page 197]
* [ʔ] occurs between vowel clusters that straddle morpheme boundaries (ibid.)

## Lenition

(These rules come from [@NheBeller1979, page 205]
